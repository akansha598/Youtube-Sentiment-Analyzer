...
def extract_topics_for_next_video(comments, num_topics=10):
    ...
    suggestion_phrases = [
        ...
        "can you recommend", "you should recommend", "can you discuss", 
        "recommend books", "recommend movies", "book reviews", 
        "movie reviews", "next book", "next movie", "book suggestions", 
        "movie suggestions", "suggest a book", "suggest a movie",
        "i recommend", "my favorite", "we want to see", "subscribers would love",
